...
import see.day.data.api.notificationService.json.getNotificationSettingSuccessResponse
...
class GetNotificationSettingTest {
    ...
    @Test
    fun given_whenGetNotificationSetting_thenWorksFine() = runTest {
        // given
        val responseJson = getNotificationSettingSuccessResponse
        ...
        // when
        val response = sut.getNotificationSetting()
